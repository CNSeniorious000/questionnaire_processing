...
def to_png(html, name, ratio=3, delay=0, driver=Driver.Chrome, remove=False):
    match driver:
        case Driver.Edge:
            options = EdgeOptions()
...
def save_and_show(plot, name, ratio=2, delay=delay, driver=Driver.Chrome, remove=True, concurrent="thread"):
